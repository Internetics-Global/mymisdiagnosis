    ...
    $(document).ready(function() {
	   ...
	   $('#form-button-save').css('display', 'none')
		...
		$('#display_mobility_level').css('display', 'none');  
		   ...
		   $("#button_post_image,#button_post_thumb,#button_pack_image").click(function(){
		   ...
		   //console.log( this.name )
	        ...
	        if (this.name == 'button_post_image') {
	        var files = $('#file_post_image')[0].files;	 
	        }  
	        ...
	        if(files.length > 0 ){
				   ...
				   if (this.name == 'button_post_image') {
		           $change_this_id = id_post_image['value'];
		           $cancel_button = '#cancel_button_post_image';

		           $user_folder = userfolder_post_image['value'];
		           $card_folder = cardfolder_post_image['value'];
