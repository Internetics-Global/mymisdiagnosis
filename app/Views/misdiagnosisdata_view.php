    ...
    $(document).ready(function() {
	   ...
	   $('#form-button-save').css('display', 'none')
		...
		$('#display_mobility_level').css('display', 'none');  
		   ...
		   $("#button_data_image,#button_post_thumb,#button_pack_image").click(function(){
		   ...
		   //console.log( this.name )
	        ...
	        if (this.name == 'button_data_image') {
	        var files = $('#file_data_image')[0].files;	 
	        }  
	        ...
	        if(files.length > 0 ){
				   ...
				   if (this.name == 'button_data_image') {
		           $change_this_id = id_data_image['value'];
		           $cancel_button = '#cancel_button_data_image';

		           $user_folder = userfolder_data_image['value'];
		           $card_folder = cardfolder_data_image['value'];
