        ...
        <script src="<?php echo site_url();?>public/assets/grocery_crud/js/jquery-1.11.1.min.js"></script>
        
<script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/build/js/global-libs.min.js"></script>
<script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/bootstrap.min.js"></script>
<script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/bootbox.min.js"></script>
<script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/bootbox.locales.min.js"></script>
        
        
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/jquery-plugins/jquery.form.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/common/cache-library.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/common/common.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/jquery-plugins/gc-dropdown.min.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/jquery-plugins/gc-modal.min.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/jquery-plugins/bootstrap-growl.min.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/jquery-plugins/jquery.print-this.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/datagrid/gcrud.datagrid.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/datagrid/list.js"></script>
        <script src="<?php echo site_url();?>public/assets/grocery_crud/themes/internetics/js/lightbox.js"></script>
