...
<tr>
	   <td align="left">
		  ...
		  <h1 style = "font-size: 15px;">Reset your password</h1>
		  ...
		  <p>You have received this email as you or someone using your email address has tried to reset the password on myMisdiagnosis.com. </p>
